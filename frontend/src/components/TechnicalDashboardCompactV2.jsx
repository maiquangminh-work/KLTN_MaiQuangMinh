function TechnicalDashboardCompactV2({
  latestDataTime,
  currentPrice,
  predictedPrice,
  priceDiff,
  ...
  return (
    <div className="panel-section">
      <div className="card" style={{ padding: '15px 16px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, minmax(0, 1fr))', gap: '10px' }}>
          <div style={{ background: '#161a1e', border: '1px solid #2b3139', borderRadius: '10px', padding: '12px' }}>
            <div style={{ color: '#848e9c', fontSize: '12px', marginBottom: '5px' }}>Thị giá hiện tại</div>
            <div className="price">{formatVND(currentPrice * 1000)}</div>
          </div>
          <div style={{ background: '#161a1e', border: '1px solid #2b3139', borderRadius: '10px', padding: '12px' }}>
            <div style={{ color: '#848e9c', fontSize: '12px', marginBottom: '5px' }}>Giá dự báo T+1</div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, minmax(0, 1fr))', gap: '10px', marginTop: '10px' }}>
          <div style={{ background: '#161a1e', border: '1px solid #2b3139', borderRadius: '10px', padding: '12px' }}>
            <div style={{ color: '#848e9c', fontSize: '12px', marginBottom: '5px' }}>Mức chênh lệch</div>
            <div style={{ fontSize: '22px', fontWeight: 700, color: priceDiff >= 0 ? '#0ecb81' : '#f6465d' }}>
      ...
      <div className="card" style={{ padding: '15px 16px', border: `1px solid ${recColor}` }}>
...
export default TechnicalDashboardCompactV2;
